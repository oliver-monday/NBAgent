...
| Without [X] (key_teammate_absent) | After Teammates line | Player's raw avgs + tier hit rates in games where top-PPG whitelisted teammate was absent (n≥3); directive — Pick stage uses absence baseline as primary evaluation when teammate is OUT/DOUBTFUL; added 2026-03-20 |
