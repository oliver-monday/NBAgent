...
- **Parlay bucket performance calibration (followup, shipped 2026-04-23)** — once ≥10 Degen cards have been graded, compare Degen actual hit rate vs. its combined-market-prob range (14.3–9.1% implied after the +350–1000 widening). If Degen wildly overperforms implied, the odds-first pool is capturing real edge and the framing is validated; if it underperforms, tighten the pool (e.g., raise confidence floor for Degen-eligible picks to 74%+, or cap pool size below 25). Also compare Safe and Reach hit rates vs their ranges (33.3–50% and 22.2–33.3% respectively) to validate the quality-first pool choice for those buckets.
